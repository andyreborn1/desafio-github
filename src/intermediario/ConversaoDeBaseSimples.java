 ...
 * Você deverá converter cada valor da entrada. Se o valor for hexadecimal,
 * você deve convertê-lo para decimal e vice-versa.
 * O valor hexadecimal inicia sempre com “0x” ou também,
 * é aquele valor cuja segunda casa contém a letra 'x'.
 * <p>
 * Entrada
 * A entrada contém vários casos de teste.
 * Cada linha de entrada, com exceção da última, contém um número não-negativo, decimal ou hexa.
 * O valor decimal será menor ou igual a 231.
...
public class ConversaoDeBaseSimples {
